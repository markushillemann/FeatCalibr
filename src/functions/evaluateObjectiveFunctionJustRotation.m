function objFunc = evaluateObjectiveFunctionJustRotation(x, scanPoints, Poses, TMobile2TLS, numPoints, param, TCalibIni)
...
TCalib = PositionRodrigues2HomMatrix([x; TCalibIni(1:3,4)]);
